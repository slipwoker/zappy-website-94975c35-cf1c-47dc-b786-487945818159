  ...
  if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
      ...
      if (!emailRegex.test(email)) {
        alert('אנא הזינו כתובת דוא"ל תקינה');
        return;
      }
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "שביל הריפוי משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            const response = await fetch('https://api.zappy5.com/api/email/contact-form', {
                ...
                body: JSON.stringify({
                    websiteId: '94975c35-cf1c-47dc-b786-487945818159',
                    name: data.name || '',
                    email: data.email || '',
